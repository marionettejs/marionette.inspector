...
var getViewIndex = function() {
    var viewInfo = window.__agent.getAppViewInfoFromElement($0);
    return viewInfo? viewInfo.index : undefined;
};

window.onload = function() {
    // check if the backbone agent is active
    chrome.devtools.inspectedWindow.eval("("+isAgentActive+")()", function(result, isException) {
