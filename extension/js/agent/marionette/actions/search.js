    ...
    var search = function(appObserver, app) {
        ...
        _.each($els, function($el) {
            ...
            $el.on('mouseleave.regionSearch', function(e) {
                ...
                // we used to unhlight views when you left the
                // the element but that broke when we started showing a higlight mask
                // also from the user expeience level, it's nice to keep it
            ...
            $el.on('mousedown.regionSearch', function(e) {
                ...
                agent.stopSearch(appObserver, app);
